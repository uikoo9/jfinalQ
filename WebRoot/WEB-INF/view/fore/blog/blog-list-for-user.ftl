		...
		<div class="row">
			...
			<div class="col-xs-2 col-sm-3 col-md-3 col-lg-3">
				<div class="list-group" style="position:fixed;top:70px;margin-right:20px;">
					<#if blogTypeId??>
						<a href="${base}/blog/listForUser" class="list-group-item">所有文章</a>
					<#else>
						<a href="${base}/blog/listForUser" class="list-group-item active">所有文章</a>
					</#if>
					<#list blogTypes as type>
						<a href="${base}/blog/listForUser/${type.id}" class="list-group-item <#if blogTypeId?? && blogTypeId == type.id>active</#if>">${type.blog_type_name}</a>
					</#list>
				</div>
			</div>
		</div>
