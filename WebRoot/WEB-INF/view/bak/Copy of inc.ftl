...
<#macro bsnav pos='top' sname='uikoo9.com' shref='http://uikoo9.com/'>
	<nav role="navigation" class="navbar navbar-default" style="margin-bottom:0;background-color:#FFFFFF;">
		<div class="container">
			<div class="navbar-header">
				...
				<a href="${shref}" class="navbar-brand"><strong style="color:#FFCC33;">${sname}</strong></a>
			</div>
